    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.SmallIntegerField(validators=[django.core.validators.MaxValueValidator(10, 'Максимальная оценка - 10!'), django.core.validators.MinValueValidator(1, 'Минимальная оценка - 1!')], verbose_name='Поставьте оценку от 1 до 10')),
                ('pub_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата публикации')),
            ],
            options={
                'verbose_name': 'Отзыв',
